          ...
          <div className={r.register}>
            <form onSubmit={handleSubmitFetch} className={r.register__form}>
              <div className={r.register__form__title}>
                <span className={r.logo}>ChatAi</span> - это мессенджер, который
                предлагает быстрый и удобный чат для пользователей. Он имеет
                простой и интуитивно понятный интерфейс, который позволяет
                пользователям легко общаться друг с другом.
              </div>
              ...
              <button type="submit" className={r.register__form__label__btn}>
                Войти
              </button>
            </form>
          </div>
